...
class AsesiController extends Controller
{
    ...
    public function update(Request $request, $id) {
        ...
        $request->validate([
            ...
            'email' => ['min:3', 'required', 'unique:user'.auth()->id()],
    ...
    public function formulirapl2_update(Request $request)
    {
        ...
        $request->validate([
            ...
            'email.required' => 'Email anda harus diisi',
            'email2.required' => 'Email alternative anda harus diisi',
    ...
    public function formulirapl3_update(Request $request)
     {
        ...
        $request->validate([
            ...
            'name.required' => 'Nama anda harus diisi',
            'name.min' => 'Nama minimal 3 karakter',
            'email.min' => 'Email minimal 3 karakter & format @',
            'email.required' => 'NIK anda harus diisi',
