            ...
            @foreach ($carousel as $asu)
                <div class="item item-1">
                    <div style="background-image: url('{{ asset($asu->image) }}')" class="img-fill">
                        ...
                        <h6>Selamat Datang di Website LSP Geomatika</h6>
                        <h4>Kami hadir untuk melayani anda dengan sepenuh hati</h4>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 align-self-center">
                    <p>
                        Saat ini LSP P3-GEOMATIKA memiliki :
                    </p>
                    <div class="row">
                        <div class="col-md-6">
    ...
    <div class="team">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-heading">
                        <h2>Pengelola LSP-GEOMATIKA<em> </em></h2>
                        <span>▬▬▬▬▬<em>▬▬▬▬▬</em></span>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <table class="table">
                        <tr>
                            ...
                            <td align="center" style="width: 200px"><a href="https://www.atrbpn.go.id/"
                                    target="_blank" rel="noopener noreferrer"><img
                                        src="{{ asset('general/assets/images/logo-atrbpn-small.png') }}"
                                        height="100px"></a></td>
                            <!-- <td align="center" style="width: 200px"><a href="https://adasolusi.biz.id/" target="_blank"
                                    rel="noopener noreferrer"><img
                                        src="{{ asset('general/assets/images/P3 GEOMATIKA_small.png') }}"
                                        height="100px"></a>
                            </td> -->
