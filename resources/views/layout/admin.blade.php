...
<body class="@yield('sidebar')">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row default-layout-navbar">
            ...
            <div class="navbar-menu-wrapper d-flex align-items-stretch">
                ...
                <ul class="navbar-nav navbar-nav-right">
                    ...
                    {{-- <li class="nav-item">
                        <a class="nav-link count-indicator" id="notificationDropdown" target="_blank"
                            href="http://localhost/phpmyadmin/index.php?route=/database/structure&server=1&db=lspP3-GEOMATIKA">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item d-none d-lg-block">
                        ...
                        <div class="collapse" id="sidebar-layouts">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ Route('prodi.index') }}">Jenjang</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <li class="nav-item d-none d-lg-block">
                        ...
                        <div class="collapse" id="sidebar-layouts22">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('form1.index') }}">Dokumen Penunjang APL-01</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('404') }}">Dokumen APL-02</a>
                                </li>
                            </ul>
                        </div>
                    </li>
    ...
    <footer class="footer">
        <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text text-white text-center text-sm-left d-block d-sm-inline-block">Copyright © 2024
                &diamondsuit; All Right Reserved
                </span>
            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-white text-center">Designed & Developed By <a href="http://adasolusi.biz.id/" target="_blank">Tim IT Ada Solusi ID.</a> </span>
        </div>
    </footer>
