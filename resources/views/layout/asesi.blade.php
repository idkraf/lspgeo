...
<body class="@yield('sidebar')">
                ...
                <ul class="navbar-nav navbar-nav-left">
                    ...
                    <li>
                        <div class="card-subtitle2">
                            <h5> <i class="fas fa-user"></i> WEBSITE ASESI - LEMBAGA SERTIFIKASI PROFESI GEOMATIKA
                                </h5>
                        </div>
                    </li>
                </ul>
    ...
    <footer class="footer">
        <div class="d-sm-flex justify-content-center justify-content-sm-between">
            ...
            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-white text-center">Designed & Developed By <a href="http://adasolusi.biz.id/" target="_blank">Tim IT</a> <a href="https://adasolusi.biz.id/" target="_blank">ADA SOLUSI ID
                </a>.</span>
        </div>
    </footer>
