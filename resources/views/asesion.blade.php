                    ...
                    <div class="d-flex flex-row">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-black font-weight-bold">NIM :
                                {{ Auth::user()->email }}</p>
                            <p class="text-black font-weight-bold">PESERTA LSP GEOMATIKA</p>
    ...
    <div class="row">
        ...
        {{-- <div class="card col-md-5">
            <div class="card-body">
                ...
                <br><br>
                <p style="font-size: 20px"><i class="fab fa-whatsapp-square"></i> +62-819-1949-0716 </p>
                <p style="font-size: 20px"><i class="fas fa-envelope-square"></i> info@lspgeomatika.or.id</p>
                <p style="font-size: 20px"><i class="fas fa-envelope-square"></i> lsp3geomatika@gmail.com</p>
            </div>
        </div> --}}
    </div>
