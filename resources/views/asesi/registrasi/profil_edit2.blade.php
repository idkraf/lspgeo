...
@section('judul')
    Edit Data Pribadi | LSP-P3 GEOMATIKA
@endsection
                ...
                <div id="collapse-" class="" role="tabpanel" aria-labelledby="heading-11" data-parent="#accordion-4">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Nama Lengkap Sesuai KTP</label>
                                    <div class="col-sm-9">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" maxlength="25" class="form-control" name="KTP"
                                            value="{{ old('ktp', Auth::user()->ktp) }}">
                                        @error('ktp')
                                            <div class="text-danger mt-2 text-sm">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Nomor Handphone (WA Aktif)</label>
                                    <div class="col-sm-9">
                                        <div class="input-group-prepend">
