...
@section('judul')
    Mengisi Formulir | LSP-P3 GEOMATIKA
@endsection
                ...
                <div class="modal-content">
                    <form action="{{ route('registrasi.update', $data->id) }}" method="post"
                        ...
                        <div class="modal-body">
                            ...
                            <p>Apakah anda yakin ingin akan mengirim data pendaftaran ini ke Admin LSP-P3 GEOMATIKA?</p>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>6. Data pendaftaran akan terkirim ke Admin LSP-P3 GEOMATIKA.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Tutup</button>
                </div>
