...
<head>
    ...
    <title>Register | LSP GEOMATIKA</title>
    ...
    <div class="container-fluid px-1 px-md-5 px-lg-1 px-xl-5 py-5 mx-auto">
        <div class="card card0 border-0">
                ...
                <div class="col-lg-6">
                    <div class="card1 pb-5">
                        <div class="row px-3 justify-content-center mt-4 mb-5 border-line">
                            ...
                            <!-- <img src="{{asset('assets/images/logo/P3 GEOMATIKA_small.png')}}" class="logo3"> -->
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="card2 card border-0 px-4 py-5">
                            <div class="row mb-4 px-3">
                                <h6 class="mb-0 mr-4 mt-2">Lembaga Sertifikasi Profesi Pihak Ke Tiga Geomatika</h6>
                            </div>
                            <div class="row px-3">
                            ...
                            <!-- <div class="row px-3">
                                <label class="mb-1"><h6 class="mb-0 text-sm">Nomor Induk Kependudukan</h6></label>
                                <input type="number" required minlength="1" maxlength="50" name="ktp">
                                @error('ktp')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="row px-3">
                                <label class="mb-1"><h6 class="mb-0 text-sm">No Handphone WA</h6></label>
                                <input type="no_hp" maxlength="15" name="no_hp">
                                @error('no_hp')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <!-- <div class="row px-3">
                                <label class="mb-1"><h6 class="mb-0 text-sm">Pekerjaan</h6></label>
            ...
            <div  style="background-color: #ec3732;" class="bg text-white py-4">
                <div class="row px-3">
                    <small class="ml-4 ml-sm-5 mb-2">Copyright &copy; 2024. Designed & Developed By <a href="http://adasolusi.biz.id/" target="_blank">Ada Solusi ID </a> 
                    <!-- <a href="https://adasolusi.biz.id/" target="_blank">Ada Solusi Indonesia</small>--> 
                </div>
            </div>
        </div>
    </div>
