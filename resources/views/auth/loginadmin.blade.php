...
<head>
    ...
    <title>Login-Admin | LSP GEOMATIKA</title>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="card2 card border-0 px-4 py-5">
                            <div class="row mb-4 px-3">
                                <h6 class="mb-0 mr-4 mt-2">Lembaga Sertifikasi Profesi Pihak Ke tiga GEOMATIKA
                                    </h6>
                            </div>
                            <div class="row px-3 mb-4 w3-panel w3-border-bottom">
                                <label style="padding-left: 35%;">Login Admin LSP - GEOMATIKA</label>
                            </div>
                            <div class="row px-3">
                                <label class="mb-1">
            ...
            <div style="background-color: #000;" class="bg text-white py-4">
                <div class="row px-3">
                    <small class="ml-4 ml-sm-5 mb-2">Copyright &copy; 2022. Designed & Developed By <a
                            href="http://adasolusi.biz.id/" target="_blank"> Ada Solusi ID
                        </a> <!--<a href="https://adasolusi.biz.id/" target="_blank">Ada Solusi ID
                            </small> -->
                </div>
            </div>
        </div>
