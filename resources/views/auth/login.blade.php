...
<head>
    ...
    <title>Login-Asesi | LSP GEOMATIKA</title>
    ...
    <div class="container-fluid px-1 px-md-5 px-lg-1 px-xl-5 py-5 mx-auto">
        <div class="card card0 border-0">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="card2 card border-0 px-4 py-5">
                            ...
                            <div class="row px-3 mb-4 w3-panel w3-border-bottom">
                                <label style="padding-left: 35%;">Login Peserta</label>
                            </div>
                            <div class="row px-3">
                                <label class="mb-1">
            ...
            <div style="background-color: #ec3732;" class="bg text-white py-4">
                <div class="row px-3">
                    <small class="ml-4 ml-sm-5 mb-2">Copyright &copy; 2024. Designed & Developed By <a
                            href="http://www.adasolusi.biz.id/" target="_blank"> 
                            Ada Solusi ID</a> <!-- <a href="https://adasolusi.biz.id/" target="_blank">Ada Solusi
                            ID</small>-->
                </div>
            </div>
        </div>
