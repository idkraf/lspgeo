...
@section('judul')
    Profil LSP-P3 GEOMATIKA | Admin LSP P3 GEOMATIKA
@endsection
...
@section('isi')
    ...
    <div class="page-header">
        <h3>
            <i class="fas fa-cogs"></i> Settingan Profil LSP-P3 GEOMATIKA
        </h3>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-custom  bg-danger">
                <li style="color: #f64d4d" class="breadcrumb-item"><a href="{{ route('admin') }}">Dashboard</a></li>
                <li style="color: #fff" class="breadcrumb-item active" aria-current="page">Settingan Profil LSP-P3 GEOMATIKA</li>
            </ol>
        </nav>
    </div><br>
