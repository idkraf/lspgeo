...
@section('isi')
    ...
    <div class="page-header">
        <h4>
            <i class="fa  fa-pencil-alt"></i> Jenjang
        </h4>
        <!-- /////////////////////////////////// -->
        <!-- BREADCRUMB -->
        <!-- /////////////////////////////////// -->
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-custom  bg-danger">
                ...
                <li style="color: #fff" class="breadcrumb-item active" aria-current="page">Jenjang</li>
            </ol>
        </nav>
    </div><br>
    <!-- /////////////////////////////////// -->
            ...
            <div class="card-header" role="tab" id="heading-11">
                <h6 class="mb-0">
                    <a class="collapsed" data-toggle="collapse" href="#collapse-11" aria-expanded="true"
                        ...
                        &plus; Klik disini Untuk Menambahkan Jenjang
                    </a>
                </h6>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Jenjang - PS</label>
                                    <div class="col-md-12">
    ...
    <div class="card">
        <div class="card-body">
            <h4 class="card-title"><i class="fas fa-table"></i> Table Jenjang / Program Studi</h4>
            <div class="row">
                <div class="col-12">
                                        ...
                                        <thead>
                                            <tr class="bg-danger text-white" role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="order-listing"
                                                    ...
                                                    style="width: 1035.75px;">Jenjang</th>
                                            </tr>
                                        </thead>
                                        <tbody>
