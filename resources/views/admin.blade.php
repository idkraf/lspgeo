    ...
    <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-custom  bg-danger">
                <li style="color: #f64d4d" class="breadcrumb-item"><a href="{{ route('admin') }}">LSP GEOMATIKA</a></li>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-column flex-md-row align-items-center justify-content-between">
                    ...
                    <!-- <div class="statistics-item">
                        <div class="card-img">
                            <img src="{{ asset('general/assets/images/P3 GEOMATIKA_small.png') }}" width="90px" alt="">
                        </div>
                    </div> -->
                    <div class="statistics-item">
                        <div class="card-img">
                    ...
                    <div class="statistics-item">
                        ...
                        <p>
                        <ul>
                            <li><i class="icon-sm far fa-comment mr-2"></i>+62-819-1949-0716</li>
                            <li><i class="icon-sm far fa-envelope mr-2"></i>info@lspgeomatika.or.id</li>
                            <li><i class="icon-sm fab fa-instagram mr-2"></i>
                                <a href="https://www.instagram.com/lspgeomatika target="_blank">lspgeomatika
                            </li>
                            </a>
                        </ul>
                        </p>
